...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,1);
  Lcd_string(&lcd, "HARRISH VENKAT V");
  HAL_Delay(500);
  Lcd_cursor(&lcd, 1,1);
  Lcd_string(&lcd, "212223240049");
  HAL_Delay(500);
  while (1)
  {
  }
...
![WhatsApp Image 2025-09-23 at 08 33 48_63808440](https://github.com/user-attachments/assets/ffb681de-f701-43af-8b4f-a752699ce36e)
